    ...
    <div className="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-12 gap-y-12 gap-x-8 xl:gap-x-12">
            <div className="col-span-2 md:col-span-4 xl:pr-8">
                <img className="w-auto h-9" src="https://i.pinimg.com/474x/75/eb/a7/75eba7058f3942931d5097afe551b8a8.jpg" alt="" />

                <p className="text-base leading-relaxed text-gray-600 mt-7">The biggest risk is not taking a risk. In a world that's changing really quickly, the only strategy that is guaranteed to fail is not taking risks.</p>
